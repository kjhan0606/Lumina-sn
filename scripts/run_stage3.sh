...
export OMP_NUM_THREADS=32 CUDA_VISIBLE_DEVICES=0
...
export LUMINA_COUPLED_NEWTON=1
export LUMINA_A4_GLOBAL=1 LUMINA_COUPLED_JNU_PHOTOION=1 LUMINA_FROZENIN=1
...
run() {  # $1 = tag, $2 = dep_source (0|1)
  local OUT=logs/stage3_toy06_$1$SUF
  mkdir -p "$OUT"
