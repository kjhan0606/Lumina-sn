...
case "${1:-all}" in
  ...
  P8)  export LUMINA_CMF_EPAY=2 LUMINA_CMF_EPAY_SMIN=5 LUMINA_CMF_BF_MILNE=2 LUMINA_CMF_EPAY_HOTF=0 LUMINA_CMF_OTS=1; run epay8 "" ;;
  P9)  export LUMINA_CMF_EPAY=2 LUMINA_CMF_BF_MILNE=2 LUMINA_CMF_EPAY_HOTF=0; run epay9 "" ;;
  P10) export LUMINA_CMF_EPAY=2 LUMINA_CMF_EPAY_SMIN=5 LUMINA_CMF_BF_MILNE=2 LUMINA_CMF_EPAY_HOTF=0; run epay10 "" ;;
