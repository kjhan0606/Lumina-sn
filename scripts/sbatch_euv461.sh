...
export LUMINA_KPEMISS_FB_OTS_NUMIN=6.50e15 # [EUV461] 461A: EXTEND case-B/OTS to the Fe III
                                           #   EXCITED-edge band (404-461A). tepop1 forensic:
                                           #   s8 over-ionization = LOCAL FeIV->III 461A recomb
                                           #   loop (79% kpkt-fb), escaping the old 405A cutoff.
                                           #   Edges redward of 461A (nu<6.50e15) stay untouched.
