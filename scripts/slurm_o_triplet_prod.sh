...
# #281 O triplet NLTE PRODUCTION on v3_femerge_capraise ref.
# Smoke 157642 (200K x 3): Snifs_formal 0.1752 vs capraise 157640 (800K x 12): 0.1865.
# 800K x 12 with same SCALE stack (FE=2.0, CO=0.3, NI_UV=0.3, NI2_OPT=0.05, CA2=3.0, S9=0.05).
# Binary auto-selected by GPU arch (sm_80 a100, sm_90 h100/h200).
...
de_tag=$(echo "$de" | tr '.' 'p')
label="oTri_prod_vi${vi_tag}_L${l_tag}_de${de_tag}_${tag}"
...
echo "=== OTRI-PROD VI=$VI_KMS L=$L_scale DE=$DE_ARG | FE=$FE_FAC CO=$CO_FAC [${label}] ==="
