#!/bin/bash
#SBATCH --job-name=ddc15_radeq_nebular
...
#   LUMINA_RADEQ_HYBRID_MODE=nebular -> route (b): heat=cool vs dilute W·B_nu(T_rad)
...
env LUMINA_BF_OPACITY=1 \
    ...
    LUMINA_RADEQ_HYBRID_MODE=nebular \
