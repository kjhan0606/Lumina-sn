#!/bin/bash
#SBATCH --job-name=parity27_tepin
...
# re-solve b4 battery. Binary withParityQ (d32ceba9), P physics otherwise.
set -e
...
export LUMINA_BIN=lumina_cuda.withParityQ
export LUMINA_KPACKET=1
export LUMINA_EVENT_LOG=1
export PKTS=100000 NITER=12 P0TAG=parity27
