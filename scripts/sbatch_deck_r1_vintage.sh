...
# Slurm copies this file below /var/spool/slurmd/scripts.  The submitted
# REPO_ROOT is therefore authoritative; BASH_SOURCE is only a local fallback.
...
# The read-only verifier is last.  Propagate exactly its exit status to Slurm.
set +e
