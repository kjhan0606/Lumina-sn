#!/bin/bash
#SBATCH --job-name=paper_ddc15_v3asEfloorEPS_2002bo
...
# #288 EPS_IR sweep on α v1 (LUMINA_NLTE_FLOOR_REG=1) base, SN 2002bo.
# Same physics as v3asE_floor (paper DDC15 params + α floor regularization);
# sweep LUMINA_EPS_IR ∈ {0.0, 0.3, 0.5, 0.7} to damp NIR over-emission
# (NIR I 1.67×, NIR II 2.10× residual after α breakthrough at 157908).
...
label="paperDDC15v3asEfloorEPS${eps_tag}_2002bo_vi${vi_tag}_L${l_tag}_${RUN_TAG}"
