#!/bin/bash
# parity29-kpops on syn08 (manual, GPU set by caller via CUDA_VISIBLE_DEVICES).
...
export PKTS=100000 NITER=12 P0TAG=parity29
...
export LUMINA_KPEMISS_REPAIR=1 LUMINA_KPEMISS_SE_POPS=1 LUMINA_KPEMISS_TE_POP=1
