...
# SkipSi v_in fine sweep: target Si II 6355 trough at HST λ_min=6144Å (v=9934 km/s).
# 155590 showed +SkipSi v_in=10400 → v=11965 (+20% blue); v_in=12500 → v=13344 (+34% blue).
# Try v_in {9000, 9500, 10000} to land trough velocity near HST 9934.
# Empirical ML target v_form=9611 km/s.
...
echo "=== skipSi vfine [${label}]  rho_off=${ro}  dexp=${de}  v_in=${vi} km/s  +SKIP_Z=14 ==="
