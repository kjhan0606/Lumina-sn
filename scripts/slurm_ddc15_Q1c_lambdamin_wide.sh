#!/bin/bash
#SBATCH --job-name=ddc15_Q1c_iron3_wide
...
# Q1c: widen Q1b LAMBDA_MIN band from [4500,7500] → [5500,9500] to cover all
# 3 red excess sub-bands (Si-red 5800-6800, OI/cont 6800-8000, Ca-IR 8000-9500).
# Q1b r03 was first lever below 0.238 floor (0.2375) but Ca-IR still 1.70× HST.
# Same base stack (Ni 0.3 + Si 0.05 + Fe 0.3 + Co 0.3 λ<4000Å ion=1).
# Binary lumina_cuda_h100_aulscale6 (LAMBDA_MIN support).
#
#   array 0 — Q1c_ref:  stack only, intra-job anchor
#   array 1 — Q1c_w05:  +SCALE5 Cr/Fe/Co III f=0.5 λ∈[5500,9500]
#   array 2 — Q1c_w03:  +SCALE5 Cr/Fe/Co III f=0.3 λ∈[5500,9500]
#   array 3 — Q1c_w015: +SCALE5 Cr/Fe/Co III f=0.15 λ∈[5500,9500]
...
LABELS=(Q1c_ref Q1c_w05 Q1c_w03 Q1c_w015)
...
label="ddc15Q1c_${tag}"
work_root="$ROOT/logs/ddc15Q1c_${SLURM_ARRAY_JOB_ID}_${label}"
mkdir -p "$work_root"
cd "$work_root"
...
echo "=== Q1c [${label}]  stack(Ni0.3/Si0.05/Fe${FE_FAC}/Co${CO_FAC}) + RED_FAC=${RED_FAC} Cr/Fe/Co III λ∈[5500,9500]  N_PKT=${N_PKT}  N_ITER=${N_ITER} ==="
...
LUMINA_AUL_SCALE5_LAMBDA_MIN=5500 \
LUMINA_AUL_SCALE5_LAMBDA_MAX=9500 \
