...
export OMP_NUM_THREADS=64 CUDA_VISIBLE_DEVICES=0
...
export LUMINA_COUPLED_NEWTON=1 LUMINA_DIP_TRACE=1 LUMINA_CN_DAMP=0.5 LUMINA_COUPLED_NEWTON_SMIN=20 LUMINA_COUPLED_JNU_PHOTOION=1 LUMINA_FROZENIN=0
export LUMINA_OUTER_ION_BOOST=1000,36
export LUMINA_CN_THI_ABS=140000
export LUMINA_NLTE_PER_ION_RESCALE=1 LUMINA_COUPLED_JNU_LSTAR=0
export LUMINA_COUPLED_LAMBDA_STAR=1 LUMINA_COUPLED_TDEP=1 LUMINA_RADEQ_LINE_RE=1
...
export LUMINA_CMF_LINERES_JBAR=1
export LUMINA_CMF_FINE_PHOTOION=1
export LUMINA_CMF_FINE_LAMLO=228
export LUMINA_CMF_FINE_PPD=2
export LUMINA_CMF_FINE_DIAG=1
