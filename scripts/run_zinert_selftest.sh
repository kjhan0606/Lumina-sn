...
"${CC:-gcc}" -O2 -w -std=gnu11 -D_GNU_SOURCE \
    ...
    tests/abundance_zero_nlte_fixture.c src/lumina_plasma.c src/bf_rate_jnu.c src/seed_capability.c src/population_contract.c \
...
"${CC:-gcc}" -O2 -w -std=gnu11 -D_GNU_SOURCE \
    ...
    src/lumina_plasma.c src/bf_rate_jnu.c src/seed_capability.c src/population_contract.c -lm -o "$BUILD_DIR/zinert_tau" >"$BUILD_DIR/tau.build.log" 2>&1 &
P2=$!
"${CC:-gcc}" -O2 -w -std=gnu11 -D_GNU_SOURCE \
    -ffunction-sections -fdata-sections -Isrc -Wl,--gc-sections \
    tests/zinert_population_fixture.c src/lumina_plasma.c src/bf_rate_jnu.c src/seed_capability.c src/population_contract.c \
...
"${CC:-gcc}" -O2 -w -std=gnu11 -D_GNU_SOURCE \
    ...
    src/lumina_plasma.c src/lumina_element_wide.c src/lumina_atomic.c src/bf_rate_jnu.c src/seed_capability.c src/population_contract.c \
