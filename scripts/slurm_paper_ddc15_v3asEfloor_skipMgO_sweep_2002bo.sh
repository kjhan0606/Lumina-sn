#!/bin/bash
#SBATCH --job-name=paper_ddc15_v3asEfloor_skipMgO_2002bo
...
# #293 Mg/O SKIP-NLTE 2-cell ablation, sibling of #292 (iron-peak).
# Targets the two largest non-iron residuals in baseline 157921:
#   Mg II 9218/9244  2.00×   (largest excess overall)
#   O I  7774        1.57×   (absorption-trough deficit)
# Probe:
#   cell 0: SKIP_Z=14,12  (Mg NLTE off)  -> Mg II 9218 2.00× attribution
#   cell 1: SKIP_Z=14,8   (O  NLTE off)  -> O I 7774 1.57× attribution
# a100_pcie/syn103 idle slot; runs in parallel with #292 array 158158_[0-2].

SKIP_Z_LIST=("14,12" "14,8")
...
echo "=== PAPER-DDC15-v3 SKIP_Z=$SKIP_Z (#293 MgO) vs SN 2002bo  VI=$VI_KMS L=$L_scale EPS_IR=$EPS_IR  RUN=$RUN_TAG [${label}] ==="
