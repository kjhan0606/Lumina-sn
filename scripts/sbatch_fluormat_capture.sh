...
#SBATCH --job-name=fluormat_capture
...
CERT_ENV=/home/kjhan/BACKUP/Eunha.A1/Claude/Lumina-sn/docs/PARITY59_FLUORMAT.env
EXPECTED_RUN_SHA=7c483d9707552893f60ced58c66ff255ab4b136f05549db5dd4d71088971c70d
EXPECTED_BENCH_SHA=bad088f5cb866adc94aae303a8adc5dd8c9c828dc7edf1529797b392607ae2fa
RUN_DIR="$DEPLOY_ROOT/scratch/fluormat_capture_${SLURM_JOB_ID:?}"
export RUN_DIR
