...
# #219c MC variance probe: confirm V3.2 clean-ζ Snifs 0.1335 (157227 cell 3) is
# real signal vs A1d-style 6σ outlier roll.
#
# 6 cells × 800K × 12 iter, all V3.2 (L=1.55) p+3.7d, vi=10600, de=9.5, W5 niF005 stack.
# Paired across 3 distinct MC seeds:
#   idx 0: V3.2 ref-ζ   seed_A
#   idx 1: V3.2 clean-ζ seed_A
#   idx 2: V3.2 ref-ζ   seed_B
#   idx 3: V3.2 clean-ζ seed_B
#   idx 4: V3.2 ref-ζ   seed_C
#   idx 5: V3.2 clean-ζ seed_C
# Pairwise (clean − ref) across 3 seeds gives 3 independent ΔSnifs samples.
...
SEED_LIST=(23111963 23111963 11223344 11223344 99887766 99887766)
SUFFIX=(refz_sA cleanz_sA refz_sB cleanz_sB refz_sC cleanz_sC)
...
label="zcmcv_${tag}_${suffix}"
work_root="$ROOT/logs/zcmcv_${SLURM_ARRAY_JOB_ID}_${label}"
mkdir -p "$work_root"
cd "$work_root"
...
echo "=== ZCMCV [${label}] L=${L_inner} L_scale=${L_scale} N_PKT=${N_PKT} seed=${SEED} SRC_REF=${SRC_REF} ==="
