...
# A100 = sm_80, use prebuilt a100 binary or build with GPU_ARCH=sm_80
BINARY="${LUMINA_BIN:-/home/kjhan/BACKUP/Eunha.A1/Claude/Lumina-sn/lumina_cuda_a100_ionmask}"
