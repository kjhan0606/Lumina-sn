#!/usr/bin/env python3
"""outerFe 10× + W1 scan vs champion + previous outerFe + HST."""
...
RUNS = {
    ...
    "outerFe 1× W1=1.0 (154062)":       ROOT / "logs/outerFe_W11p0_154062/lumina_spectrum_formal.csv",
    "outerFe 1× W1=1.7 (154061)":       ROOT / "logs/outerFe_W11p7_154061/lumina_spectrum_formal.csv",
    "outerFe 10× W1=0.5 (154066)":      ROOT / "logs/outerFe10x_W10p5_154066/lumina_spectrum_formal.csv",
    "outerFe 10× W1=1.0 (154067)":      ROOT / "logs/outerFe10x_W11p0_154067/lumina_spectrum_formal.csv",
    "outerFe 10× W1=1.7 (154065)":      ROOT / "logs/outerFe10x_W11p7_154065/lumina_spectrum_formal.csv",
}
