...
def main()->int:
 ...
 dump(OUT/"A2_10_L6_GATE.json",{"status":"BLOCKED_FIXED_T_AND_MISSING_LINEHEAT","reason_code":"BLOCKED_FIXED_T_AND_MISSING_LINEHEAT","child_rc":3,"wrapper_rc":0,"CHAIN":"BLOCKED_FIXED_T_AND_MISSING_LINEHEAT","ORACLE_INPUT":"BLOCKED_FIXED_T_AND_MISSING_LINEHEAT","heat_residual_qualified":False,"truth_f_cov":None,"line_owner_overlap_shells":0,"max_line_owner_closure":0.0})
 print(f"{'PASS' if ok else 'FAIL'} A2_10_SELFTEST N1_N8={sum(v['status']=='PASS' for v in neg.values())}/8 L6=BLOCKED_FIXED_T_AND_MISSING_LINEHEAT")
