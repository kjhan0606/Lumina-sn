...
export LUMINA_PURE_CMFGEN=1 LUMINA_PURE_CMFGEN_ITER=16 LUMINA_CMFGEN_ALI_ITER=8
...
export LUMINA_COUPLED_NEWTON=1 LUMINA_DIP_TRACE=1 LUMINA_COUPLED_NEWTON_SMIN=20 LUMINA_COUPLED_JNU_PHOTOION=1 LUMINA_FROZENIN=0
