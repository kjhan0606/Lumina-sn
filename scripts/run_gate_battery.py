...
PREFLIGHTS = (
    ...
    ("A2_10_LINE_SATURATION_INTERSECTION", "tests/a2_10_line_saturation_intersection_selftest.py", ()),
    ("A2_10_PHASE_BASELINE_STREAMS", "tests/a2_10_phase_baseline_streams_selftest.py", ()),
    ("A2_10_CMFGEN_LINE_SATURATION_COMPARISON", "tests/a2_10_cmfgen_line_saturation_comparison_selftest.py", ()),
    ("A2_10_LINE_SATURATION_PER_ION_COVERAGE", "tests/a2_10_line_saturation_per_ion_coverage_selftest.py", ()),
    ("A2_10_LINE_SATURATION_PER_ION_MONITOR", "tests/a2_10_line_saturation_per_ion_monitor_selftest.py", ()),
