...
# #273 NLTE O II/III smoke test on FEMERGE Phase 9b best cell (157508):
#   vi=11600, L_scale=2.45, de=10.5, p+3.7d, V3.1 SCALE stack frozen.
# Purpose: (a) plasma init succeeds with NLTE_MAX_IONS=30, (b) DR lookup hits
# new {Z=8, ion=1/2} entries, (c) O II/III NLTE doesn't trip the #219e
# top-level-pop singularity. 200K x 6 iter (single seed).
