...
# Path-A: outerFe abundance + v_in axis extension at champion (rho_off=0, n=9.0).
# User prescription: 함량 + 팽창속도 동시조정 → 3050Å trough를 충분히 blueshift.
# v_in ∈ {12500, 15500, 17500} km/s. v_out=28750 fixed.
...
echo "=== outerFe+vin [${label}]  rho_off=${ro}  dexp=${de}  v_in=${vi} km/s ==="
