#!/bin/bash
#SBATCH --job-name=paperli_2002bo
...
# Atomic data: tardis_reference_v3_femerge_capraise_bbfix_asE (current SRC).
# NOTE: SRC still has the OLD metastable hardcode (Bug #2). Re-run after
# pipeline regeneration to compare scatter-mode w/ correct metastable flags.
