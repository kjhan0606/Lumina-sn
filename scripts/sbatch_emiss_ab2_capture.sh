...
#SBATCH --job-name=emiss_ab2_capture
...
CERT_ENV=/home/kjhan/BACKUP/Eunha.A1/Claude/Lumina-sn/docs/PARITY59_EMISS_AB2.env
EXPECTED_RUN_SHA=22d563955fd4c3d5446e9e76d8fb89fb988c6b3f88556ca455b7371809d7af68
EXPECTED_BENCH_SHA=bad088f5cb866adc94aae303a8adc5dd8c9c828dc7edf1529797b392607ae2fa
RUN_DIR="$DEPLOY_ROOT/scratch/emiss_ab2_capture_${SLURM_JOB_ID:?}"
export RUN_DIR
