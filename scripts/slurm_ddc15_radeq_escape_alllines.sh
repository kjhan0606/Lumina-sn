#!/bin/bash
#SBATCH --job-name=ddc15_radeqescall
...
# ~20x at shell 0). Physics-verified faithful fix = radiative-escape bb cooling (ALL lines, incl forbidden)
...
# stop cooling. NLTE-tracked n_up (LUMINA_RADEQ_COOL_NLTE_ONLY=0). No double-count:
...
echo "=== DDC15 0.976d RADEQ-Te + radiative-escape bb cooling (ALL lines, incl forbidden) ==="
