#!/bin/bash
#SBATCH --job-name=ddc15_radeq_adiab
...
#   LUMINA_RADEQ_HYBRID_MODE=adiab -> route (a): T_e=T_e(t_0)*(t_0/t)^2 adiabatic
...
env LUMINA_BF_OPACITY=1 \
    ...
    LUMINA_RADEQ_HYBRID_MODE=adiab \
