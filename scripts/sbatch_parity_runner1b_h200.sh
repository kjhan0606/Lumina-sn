#!/bin/bash
#SBATCH --job-name=parity_runner1b
...
set -u
# Fresh-start hygiene: a STOP planted for the PREVIOUS runner must not kill this one.
rm -f /home/kjhan/BACKUP/Eunha.A1/Claude/Lumina-sn/runner_spool/STOP
