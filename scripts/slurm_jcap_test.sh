...
N_PKT=200000
N_ITER=10
jcap_tag=$(echo "$JCAP" | tr '.' 'p')
RUN_TAG="jcap${jcap_tag}"
...
echo "=== J-CAP discriminating test  JCAP=$JCAP  LINE_INT=$LINE_INT  FIXED_PROFILE=$FIXED_PROFILE  DIFFUSE_BC=$DIFFUSE_BC  VI=$VI_KMS L=$L_SCALE_ARG  N_PKT=$N_PKT N_ITER=$N_ITER ==="
