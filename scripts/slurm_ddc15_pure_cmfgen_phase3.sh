...
env LUMINA_PURE_CMFGEN=1 \
    ...
    LUMINA_RADEQ_DIAG=1 \
    LUMINA_RADEQ_COOL_ESCAPE=${COOL_ESCAPE:-0} \
    LUMINA_RADEQ_COOL_NONNEG=0 \
    LUMINA_RADEQ_COOL_NLTE_ONLY=${COOL_NLTE_ONLY:-1} \
    LUMINA_RADEQ_LINE_RESPOND=${LINE_RESPOND:-0} \
    ...
    LUMINA_NLTE_BF_JEQB=${BF_JEQB:-0} \
    LUMINA_NLTE_EQUILIBRATE=${EQUILIBRATE:-0} \
    LUMINA_NLTE_LTE_REPAIR=${LTE_REPAIR:-0} \
    ...
    LUMINA_CMF_LINE_SOB_EPS=${SOB_EPS:-0} \
    LUMINA_CMF_OBS_JBARDET=${OBS_JBARDET:-0} \
    LUMINA_CMF_OBS_FAITHFUL=${OBS_FAITHFUL:-0} \
    LUMINA_CMF_OBS_SEI=${OBS_SEI:-0} \
    LUMINA_CMF_OBS_DVRES=${OBS_DVRES:-30} \
    LUMINA_CMF_FINE_SL_CLAMP=${FINE_SL_CLAMP:-0} \
    LUMINA_CMF_FINE_TAUMIN=${FINE_TAUMIN:-1e-12} \
    LUMINA_CMF_FINE_LINE_EPS=${FINE_LINE_EPS:-1.0} \
    LUMINA_CMF_ALAM=${CMF_ALAM:-1.0} \
    LUMINA_CMF_ADV_SPLIT=${ADV_SPLIT:-0} \
    LUMINA_CMF_FINE_JMAP=${FINE_JMAP:-0} \
    LUMINA_CMF_FINE_DIAG=${FINE_DIAG:-0} \
