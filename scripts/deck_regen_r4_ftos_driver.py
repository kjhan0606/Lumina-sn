#!/usr/bin/env python3
"""Create the R4 all-linked-f_to_s deck without overwriting any deck."""
...
NEW = ROOT / "data/tardis_reference_toy06_19p48d_sivcaiv_ftos"
...
def load_expand_module():
    spec = importlib.util.spec_from_file_location("deck_expand_r4", EXPAND)
...
def main() -> None:
    ...
    print(f"created core R4 all-linked-f_to_s deck: {NEW}")
