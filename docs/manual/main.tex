...
LUMINA implements a \textbf{restricted NLTE solver} targeting the four most important diagnostic elements: Si, Ca, Fe, and S (8 ion stages total, $\sim$2000 levels).  All other species remain on the nebular approximation.
