...
% Mark every generated page, including the title page, as an unpublished draft.
\AddToHook{shipout/foreground}{%
  \begin{tikzpicture}[remember picture,overlay]
    \node[rotate=45,scale=8,text=black!12]
      at (current page.center) {\sffamily\bfseries DRAFT};
  \end{tikzpicture}%
}
...
\newcommand{\gcm}{\ensuremath{\,\mathrm{g\,cm^{-3}}}}
