...
| 단 | 무엇이었나 | 상태 |
|---|---|---|
| **SH-GAMMA** 감마 침착 소유권 | 결정론 팔의 방사성 가열이 **항등 0** 이었다.  소비자가 0 을 "할 일 없음"으로 읽음 | **폐합** `5450518` |
| **DET-R6** 결정론 정본 line-J̄ | 생산자는 있으나 commit 에 안 실려 a209 가 막힘 | **폐합** `3ca077d` |
| **SH-GRID** 격자 포함 계약(안 B) | 생산자·소비자가 **같은 격자**인데 중개 격자가 양 끝을 파괴 | **폐합** `2e26c2f` |
...
### (a) `RADEQ_NO_BRACKET` — **SH-RADEQ**(신규 전선, 물리)
