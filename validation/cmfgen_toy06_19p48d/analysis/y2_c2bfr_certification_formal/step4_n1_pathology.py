...
print("\n=== mode by coarse bin, iter 11 (lam range from the C1 dump) ===")
...
print("\n=== N1 pathology by band (iter 11, all 50 shells pooled) ===")
...
print("\n=== kernel-weighted C1/raw ratio by shell x band (iter 11) ===")
