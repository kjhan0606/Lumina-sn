...
IT = -1          # dump iter 11 = the last block of the clean 12-iter run
...
# list printed at stdout.log:278-308.  The LOWER member of each pair is
...
print("\n=== R_bf(C2) / R_bf(GEMM), dump iter 11, GROUND levels ===")
