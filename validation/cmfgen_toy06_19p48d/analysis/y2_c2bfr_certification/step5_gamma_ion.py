...
stdout_partial.log '[CMFGEN] iter 10: T_e[0]=21210K T_e[25]=8428K T_e[49]=13051K'.
...
print("\n=== Boltzmann(T_e)-weighted Gamma_phot ratio  C2 / GEMM  (dump iter 10) ===")
...
print("\n=== absolute Gamma_phot [s^-1], C2 path (dump iter 10) ===")
print(ion[ion.consumed_in_matrix].pivot(index="ion", columns="shell",
                                        values="Gamma_C2").map(
