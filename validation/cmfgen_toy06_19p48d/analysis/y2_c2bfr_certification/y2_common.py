...
PRELIMINARY-on-partial: the input is the iter 0-10 completed block of a
walltime-killed run (logs/coevolve_consume_parity46_killed_partial/).
...
_CERT = os.path.join(ROOT,
                     "validation/cmfgen_toy06_19p48d/analysis/y2_c2bfr_certification")
# Defaults reproduce PRELIM_REPORT.md verbatim (killed-partial, iters 0-10).
# FORMAL_REPORT.md (clean 12-iter parity46) sets:
#   Y2_RUN=$ROOT/logs/coevolve_consume_parity46  Y2_OUT=$_CERT/clean
RUN = os.environ.get("Y2_RUN",
                     os.path.join(ROOT, "logs/coevolve_consume_parity46_killed_partial"))
