...
| 철회 | 사유 |
|---|---|
| **R6-4 PASS** | 사전등록은 **byte-parity**인데(`RUNG_R6...md:75`) 판정은 필터된 157줄 동일이다.  그보다 약하다.  stdout/stderr 를 **분리**해 결정적 산출물을 순서·바이트로 비교했어야 한다 |
| **단 전체 PASS** | R6-3 이 N6-1~N6-4 전항을 요구하는데 **N6-2·N6-3 미실행** |
